...
<jsp:include page="lookMenu.jsp"/>
     ...
     <jsp:include page="lookCategory.jsp"/>
		<h2 class="content-title"><span class="content-title-bar"></span>청년취업아카데미 프로그램 운영절차</h2>
		<ul>
			<li class="margin-list">
				<span class="li-dot"></span>
				기업, 사업주단체, 대학 또는 민간 우수훈련기관이 대학 및 기업과 협력하여, 취업희망 청년들을 교육하고 참여기업에<br/> 취업을 연계시키는 구조로 운영됩니다.<br>
				<strong>1단계</strong> - 재학생, 졸업(예정)자를 교육생으로 선발<br>
				<strong>2단계</strong> - 운영기관(기업, 사업주단체, 대학 또는 민간 우수훈련기관)이 선발된 학생들을 교육<br>
				<strong>3단계</strong> - 운영기관이 기업, 중견기업, 중소기업 등 참여기업에 교육생들의 취업을 연계
			</li>
		</ul>
	</div><!-- content -->

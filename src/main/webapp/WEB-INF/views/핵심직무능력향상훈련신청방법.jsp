...
<jsp:include page="lookMenu.jsp"/>
     ...
     <jsp:include page="lookCategory.jsp"/>
		<h2 class="content-title"><span class="content-title-bar"></span>중소기업 핵심직무능력향상훈련 신청방법</h2>
		<ul>
			<li class="margin-list">
				<span class="li-dot"></span>
				신청기간: 매년 2월부터(신청현황에 따라 조기마감될 수 있음)
			</li>
			<li class="margin-list">
				<span class="li-dot"></span>
				<strong>오프라인 신청방법</strong><br>훈련기관에 전화 또는 해당 훈련기관의 홈페이지를 통해 직접 신청
			</li>
			<li class="margin-list">
				<span class="li-dot"></span>
				<strong>온라인 신청 방법</strong>
			</li>
			<li class="no-style">
				<div class="width-650">
					<table>
						<tbody><tr>
							<td>
								<ul class="no-style">
									...
									<li class="no-style">
										2. 훈련기관 홈페이지에서 온라인 수강신청
									</li>
									<li class="no-style">
										3. 수강신청 후 수강신청서를 인쇄하여 법인인감(사용인감 가능) 날인 후 팩스로 송부하고 교육당일 원본제출
									</li>
									<li class="no-style">
										4. 수강신청 후 1~2일 내에 핸드폰으로 접수안내문자가 오지 않으면 훈련기관으로 반드시 확인전화										
									</li>
								</ul>
							</td>
						</tr>

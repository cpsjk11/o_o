					...
					<div class="cardTgcrlistTr2" >
						<div class="divTableArea06 ty2 tablet" id="card">
							<ul class="divTable">
								...
								<a href="javaScript:click('http://localhost:9090/view?TRPR_ID=${vo.traning_id}&TRPR_DEGR=${vo.tr_degr}&u_id=${sessionScope.userName.id}&imageCode=${vo.imageCode }')" onclick="sendre" id="getClick" class="txt" style="color:#4171df;">
										${vo.content}
									</a>
								</li>
								<li>

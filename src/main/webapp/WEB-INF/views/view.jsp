	...
	<div id="body" name="body">
		<div id="top_div">
			...
			<div style="width: 700px; height: 50px; float:right;">
				<a href="register?u_id=${userName.id}&TRPR_DEGR=${vo.TRPR_DEGR}&TRPR_ID=${vo.TRPR_ID}&company=${vo.INO_NM}&TRPR_NM=${fn:replace(vo.TRPR_NM,'&','////')}&email=${vo.TRPR_CHAP_EMAIL}&imageCode=${imageCode}" target="_blank" ><button type="button" class="btn2" id="register_btn">수강신청</button></a>&nbsp;&nbsp;

...
<body>
	...
	<div id="wrap">
		...
		<div id="user_exit_area">
			...
			<div id="btn_area">
				<input type="button" id="exit_btn" onclick="javascript:location.href='/remove'" value="회원탈퇴">
			</div>
		</div>
	...
	<%-- <div id=user_exit_area>
			<div class="content">
				...
				<button type="button" class="btnType1" id="anysignLink4" onclick="javascrip:location.href='/mypage/remove&id=${sessionScope.userName.id}'">회원탈퇴</button>
			</div> --%>
	</div>

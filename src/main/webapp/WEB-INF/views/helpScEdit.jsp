	...
	<div id="wrap">
		...
		<div id="write_area">
			...
			encType="multipart/form-data" id="write_panel">
					<div id="title_area">
						<span>제목 : </span>
						<input type="text" id ="subject" name="subject" placeholder="제목을 입력해주세요" maxlength="30" value="${vo.subject }">
					</div>
					<div id="contetn_area">
						<textarea name="content" id="content" 
							rows="8">${vo.content }</textarea>
					</div>
					<input hidden="" name="b_idx" id="b_idx" value="${vo.b_idx }">
					<input hidden="" name="bname" id="bname" value="${bname }">
					<input hidden="" name="id" id="id" value="${sessionScope.userName.id }">
					<input hidden="" name="writer" id="writer" value="${sessionScope.userName.name }">
				</form>
				<div id="btn_area">

/* ! Chart.js v2.9.4 https://www.chartjs.org (c) 2020 Chart.js Contributors
...
!function (t, e) {
        ...
        n = function (t, e) {
            ...
            a.rgb.ansi16 = function (t) {
                ...
                if (0 === (r = Math.round(r / 50))) 
                    return 30;
                var o = 30 + (
                    Math.round(i / 255) << 2 | Math.round(n / 255) << 1 | Math.round(e / 255)
                );
                return 2 === r && (o += 60),
                o
            },
            ...
            a.rgb.ansi256 = function (t) {
                ...
                return e === n && n === i
                    ...
                    : 16 + 36 * Math.round(e / 255 * 5) + 6 * Math.round(n / 255 * 5) + Math.round(
                        i / 255 * 5
                    )
            },
            ...
            a.rgb.hex = function (t) {
                var e = (
                    ((255 & Math.round(t[0])) << 16) + ((255 & Math.round(t[1])) << 8) + (255 & Math.round(t[2]))
                )
                    .toString(16)
                    .toUpperCase();
    ...
    function r(t, e) {
        for (var i = [
            e[t].parent,
            t
        ], r = n[e[t].parent][t], o = e[t].parent; e[o].parent;) 
            ...
            _parseFont: function (t) {
                var e = N.global,
                    ...
                    i = {
                        ...
                        lineHeight: S
                            .options
                            .toLineHeight(B(t.lineHeight, e.defaultLineHeight), n),
                        size: n,
    ...
    H.extend(X.prototype, {
        ...
        transition: function (t) {
            var e = this,
                ...
                a = e._view;
            return n && 1 !== t
                ? (a || (a = e._view = {}), i || (i = e._start = {}), function (t, e, n, i) {
                    var a,
                        r,
                        o,
                        s,
    ...
    H.extend(nt.prototype, {
        ...
        buildOrUpdateElements: function () {
            var t,
                ...
                i = n.getDataset(),
                a = i.data || (i.data = []);
            n._data !== a && (n._data && et(n._data, n), a && Object.isExtensible(a) && (
                e = n,
                (t = a)._chartjs
        ...
        _resolveDatasetElementOptions: function (t, e) {
            var n,
                ...
                d = s
                    .options
                    .elements[o.datasetElementType.prototype._type] || {},
        ...
        _resolveDataElementOptions: function (t, e) {
            ...
            var r,
                ...
                h = u
                    .options
                    .elements[n.dataElementType.prototype._type] || {},
    ...
    var gt = K.extend({
            ...
            draw: function (t) {
                var e = this._view,
                    ...
                    l = N.global,
                    u = l.defaultColor;
                e.skip || (void 0 === t || H.canvas._isPointInArea(e, t)) && (
                        ...
                        ? e
                            ...
                            .map((function (n, i) {
                                ...
                                return {
                                    ...
                                    hidden: isNaN(e.datasets[0].data[i]) || a
                                        .data[i]
                                        .hidden,
                                    index: i
                                }
    ...
    var Bt = it.extend({
        ...
        update: function (t) {
            ...
            if (m < zt) {
                var b = l.rotation % zt,
                    ...
                    A = C
                        ? -1
                        : Math.min(_, _ * p, w, w * p),
                    D = M
                        ? 1
                        : Math.max(y, y * p, k, k * p),
                    T = S
                        ? 1
                        : Math.max(_, _ * p, w, w * p);
                u = (D - P) / 2,
                d = (T - A) / 2,
                h = -(D + P) / 2,
                c = -(T + A) / 2
        ...
        _getRingWeightOffset: function (t) {
            for (var e = 0, n = 0; n < t; ++n) 
                this
                    .chart
                    .isDatasetVisible(n) && (e += this._getRingWeight(n));
            return e
        },
    ...
    var Yt = it.extend({
            ...
            updateBezierControlPoints: function () {
                ...
                if (
                    o.spanGaps && (l = l.filter((function (t) {
    ...
    var $t = it.extend({
        ...
        updateBezierControlPoints: function () {
            ...
            for (
                a.dataset._model.spanGaps && (o = o.filter((function (t) {
                    return !t._model.skip
                }))),
                t = 0,
                e = o.length; t < e; ++t
    ...
    var ge,
        ...
        me = (ge = Object.freeze({
            __proto__: null,
            default: "@keyframes chartjs-render-animation{from{opacity:.99}to{opacity:1}}.chartjs-re" +
                    "nder-monitor{animation:chartjs-render-animation 1ms}.chartjs-size-monitor,.cha" +
                    "rtjs-size-monitor-expand,.chartjs-size-monitor-shrink{position:absolute;direct" +
                    "ion:ltr;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visi" +
                    "bility:hidden;z-index:-1}.chartjs-size-monitor-expand>div{position:absolute;wi" +
                    "dth:1000000px;height:1000000px;left:0;top:0}.chartjs-size-monitor-shrink>div{p" +
                    "osition:absolute;width:200%;height:200%;left:0;top:0}"
        })) && ge.default || ge,
        ve = "$chartjs",
    ...
    var Ie = {
        ...
        acquireContext: function (t, e) {
            ...
            return n && n.canvas === t
                ? (this._ensureLoaded(t), function (t, e) {
                    var n = t.style,
    ...
    var Le = {
        ...
        Re = {
            ...
            updateScaleDefaults: function (t, e) {
                this
                    .defaults
                    .hasOwnProperty(t) && (this.defaults[t] = H.extend(this.defaults[t], e))
            },
                ...
                if (p.length) {
                    ...
                    for (e = 0, n = p.length; e < n; ++e) 
                        w.push((
                            ...
                            {
                                xLabel: a
                                    ? a.getLabelForIndex(o, s)
                                    : "",
                                yLabel: r
                                    ? r.getLabelForIndex(o, s)
                                    : "",
                                label: u
    ...
    H.extend(tn.prototype, {
        ...
        resize: function (t) {
            var e = this,
                ...
                o = Math.max(0, Math.floor(
                    a
                        ? r / a
                        : H.getMaximumHeight(i)
                ));
        ...
        update: function (t) {
            ...
            if (t && "object" == typeof t || (t = {
                ...
                i.updateLayout(),
                i.options.animation && i.options.animation.duration && H.each(
                    a,
                    (function (t) {
                        t.reset()
                    })
        ...
        updateHoverStyle: function (t, e, n) {
            ...
            "dataset" === e && this
                .getDatasetMeta(t[0]._datasetIndex)
        ...
        handleEvent: function (t) {
            ...
            H.callback(i.onHover || i.hover.onHover, [
                t.native, n.active
            ], n),
            "mouseup" !== t.type && "click" !== t.type || i.onClick && i
                .onClick
                .call(n, t.native, n.active),
    ...
    function nn() {
        throw new Error(
            "This method is not implemented: either no adapter can be found or an incomplet" +
            "e integration was provided."
        )
    }
    function an(t) {
        this.options = t || {}
    ...
    function pn(t, e) {
        return H.extend(H.options._parseFont({
            ...
            color: H
                .options
                .resolve([e.fontColor, t.fontColor, N.global.defaultFontColor])
        })
    }
    function mn(t) {
        var e = pn(t, t.minor);
    ...
    var xn = K.extend({
        ...
        return l._ticks = o,
            ...
            l.fit(),
            l.afterFit(),
            l._ticksToDraw = u.display && (u.autoSkip || "auto" === u.source)
                ? l._autoSkip(o)
                : o,
        ...
        convertTicksToLabels: function () {
            ...
            this.ticks = this
                .ticks
                .map(t.userCallback || t.callback, this)
        },
    ...
    var yn = xn,
        ...
        kn = yn.extend({
            ...
            _configure: function () {
                ...
                n && (t._startValue = t.minIndex - (
                    e
                        ? .5
                        : 0
                ), t._valueRange = Math.max(n.length - (
                    e
                        ? 0
                        : 1
                ), 1))
    ...
    function An(t, e, n, i) {
        var a,
            ...
            s = function (t, e, n) {
                var i = [
                    n.type, void 0 === e && void 0 === n.stack
                        ? n.index
                        : "",
                    n.stack
                ].join(".");
    ...
    function Dn(t, e, n) {
        ...
        for (i = 0; i < r; ++i) 
            a = t._parseValue(n[i]),
            isNaN(a.min) || isNaN(a.max) || e
                .data[i]
                .hidden || (t.min = Math.min(t.min, a.min), t.max = Math.max(t.max, a.max))
        }
    var Tn = Cn.extend({
            determineDataLimits: function () {
                var t,
            ...
            for (t = 0; t < d; ++t) 
                ...
                a.min = H.isFinite(a.min) && !isNaN(a.min)
                    ? a.min
                    : 0,
                a.max = H.isFinite(a.max) && !isNaN(a.max)
                    ? a.max
                    : 1,
                ...
                if (void 0 === c) 
                    ...
                    for (t = 0; t < u.length; t++) {
                        var g = [
                            ...
                            void 0 === s.stacked && void 0 === e.stack
                                ? t
                                : "",
                            e.stack
                        ].join(".");
                        if (l.isDatasetVisible(t) && h(e)) 
                            for (
                                ...
                                var p = f[g];
                                n = o._parseValue(i[a]),
                                isNaN(n.min) || isNaN(n.max) || e
                                    .data[a]
                                    .hidden || n.min < 0 || n.max < 0 || (p[a] = p[a] || 0, p[a] += n.max)
                            }
                        }
                    H.each(f, (function (t) {
                        if (t.length > 0) {
    ...
    var Xn = Cn.extend({
                ...
                H.each(e.data.datasets, (function (a, r) {
                    if (e.isDatasetVisible(r)) {
                        ...
                        H.each(a.data, (function (e, a) {
                            ...
                            isNaN(r) || o
                                .data[a]
                                .hidden || (n = Math.min(r, n), i = Math.max(r, i))
                        }))
                    }
                })),
                ...
                t.display && t.pointLabels.display
                    ? function (t) {
                        var e,
                            ...
                            a = H
                                .options
                                ._parseFont(t.options.pointLabels),
                            r = {
                                l: 0,
                                r: t.width,
                                t: 0,
            ...
            _drawGrid: function () {
                ...
                if (
                    r.pointLabels.display && function (t) {
                        var e = t.ctx,
                            n = t.options,
                            i = n.pointLabels,
                            a = Hn(n),
                    ...
                    for (a.save(), a.lineWidth = l, a.strokeStyle = u, a.setLineDash && (
                ...
                if (n.display) {
                    ...
                    H.each(t.ticks, (function (r, l) {
                        (0 !== l || n.reverse) && (
                            ...
                            n.showLabelBackdrop && (a = e.measureText(r).width, e.fillStyle = n.backdropColor, e.fillRect(
    ...
    function si(t, e) {
        ...
        null !== o
            ? +o
            : (
                a || "function" != typeof r || (o = r(e), H.isFinite(o) || (o = n.parse(o))),
                o
            )
    }
    function li(t, e) {
    ...
    var hi = yn.extend({
            ...
            determineDataLimits: function () {
                ...
                f = li(s, ri(d)) || f,
                c = c === ti
                    ? +u.startOf(Date.now(), h)
                    : c,
                f = f === Qn
                    ? +u.endOf(Date.now(), h) + 1
                    : f,
                s.min = Math.min(c, f),
                        ...
                        : "labels" === c
                            ...
                            : function (t, e, n, i) {
                                var a,
                                    ...
                                    h = e,
                                    c = [];
                                if (d && (h = +r.startOf(h, "isoWeek", d)), h = +r.startOf(
                                    h,
                                    d
                                        ? "day"
                                        : l
    ...
    var wi = {
            ...
            afterDatasetsUpdate: function (t, e) {
                ...
                for (i = 0; i < o; ++i) 
                    r = null,
                    (a = (n = t.getDatasetMeta(i)).dataset) && a._model && a instanceof kt.Line && (
                        r = {
        ...
        Ci = H.valueOrDefault;
    function Pi(t, e) {
        return t.usePointStyle && t.boxWidth > e
            ? e
            : t.boxWidth
    }
    N._set("global", {
        ...
        legendCallback: function (t) {
            var e,
                ...
                r = t.data.datasets;
            for (
                a.setAttribute("class", t.id + "-legend"),
                e = 0,
                n = r.length;
                e < n;
                e++
        ...
        draw: function () {
            ...
            if (e.display) {
                ...
                H.each(t.legendItems, (function (e, i) {
                    ...
                    x
                        ? i > 0 && _ + g + n.padding > t.left + t.minSize.width && (
                            k = d.y += y,
                            d.line++,
                    ...
                    !function (t, e, i) {
                        if (!(isNaN(m) || m <= 0)) {
                            ...
                            if (
                                ...
                                H
                                    .canvas
                                    .drawPoint(c, i.pointStyle, s, l, u, i.rotation)
                            } else 
            ...
            beforeUpdate: function (t) {
                ...
                e
                    ? (
                        ...
                        n
                            ? (pe.configure(t, n, e), n.options = e)
                            : Di(t, e)
                    )
                ...
                ? (
                    t = (
                        H.isArray(n.text)
                            ? n.text.length
                            : 1
                    ) * H.options._parseFont(n).lineHeight + 2 * n.padding,
                    e.width = i.width = a
                        ? e.maxWidth
                        : t,
                    e.height = i.height = a
    ...
    for (
        ...
        function () {
                    ...
                    i.model.skip || a.model.skip || (
                        H.almostEquals(i.deltaK, 0, this.EPSILON)
                            ...
                            : (
                                r = i.mK / i.deltaK,
                                o = a.mK / i.deltaK,
                                (l = Math.pow(r, 2) + Math.pow(o, 2)) <= 9 || (s = 3 / Math.sqrt(l), i.mK = r * s * i.deltaK, a.mK = o * s * i.deltaK)
                            )
                    );
                for (e = 0; e < h; ++e) 
                    (i = d[e]).model.skip || (
            ...
            H.getMaximumWidth = function (t) {
                ...
                var n = e.clientWidth,
                    i = n - H._calculatePadding(e, "padding-left", n) - H._calculatePadding(
                        e,
                        "padding-right",
                        n
                    ),
            ...
            H.getMaximumHeight = function (t) {
                ...
                var n = e.clientHeight,
                    i = n - H._calculatePadding(e, "padding-top", n) - H._calculatePadding(
                        e,
                        "padding-bottom",
                        n
                    ),
        ...
        en.helpers.each(
            ...
            (function (t, e) {
                en
                    .scaleService
                    .registerScaleType(e, t, t._defaults)
            })
        ),
        Li
    ) 
        Li.hasOwnProperty(Bi) && en
            .plugins
            .register(Li[Bi]);
    en
        .platform
